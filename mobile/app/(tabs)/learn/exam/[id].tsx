        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.center}>
                    ...
                    {!loading && <Text style={styles.loadingHint}>Waiting for confirmation...</Text>}
                </View>
            </View>
        );
    }
...
const styles = StyleSheet.create({
    ...
    loadingHint: { fontSize: 13, color: "#999" },
    ...
    pillRow: { backgroundColor: "#FFF", borderBottomWidth: 1, borderBottomColor: "#F0F0F0" },
    pillContent: { paddingHorizontal: 12, paddingVertical: 10, gap: 6 },
    pill: {
        width: 34,
        height: 34,
        borderRadius: 17,
    ...
    questionBadge: { backgroundColor: "#084A59", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    questionBadgeText: { fontSize: 12, fontWeight: "700", color: "#FFF" },
    pointsBadge: { backgroundColor: "#FEF3C7", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    pointsText: { fontSize: 12, fontWeight: "700", color: "#92400E" },
    essayBadge: { backgroundColor: "#EDE9FE", paddingHorizontal: 10, paddingVertical: 4, borderRadius: 8 },
    essayBadgeText: { fontSize: 11, fontWeight: "700", color: "#5B21B6" },

    questionText: { fontSize: 17, fontWeight: "600", color: "#1F2937", lineHeight: 26, marginBottom: 20 },
    ...
    optionCardSelected: { borderColor: "#084A59", backgroundColor: "#F0F9FF" },
    optionCircle: { width: 32, height: 32, borderRadius: 16, backgroundColor: "#F3F4F6", justifyContent: "center", alignItems: "center" },
