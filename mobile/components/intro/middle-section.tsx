      ...
      return (
        <View className="w-full flex flex-col items-center gap-8">
          ...
          <Text className="text-black/60 text-[18px] font-light leading-[28.80px] break-words text-center">
            Thank you for downloading our app! Enjoy all of Atlas features
    ...
    case 2:
      return (
        <View className="w-full flex flex-col items-center gap-8">
          ...
          <Text className="text-black/60 text-[18px] font-light leading-[28.80px] break-words text-center">
            Atlas is trusted by Top GCE Examiners to maintain the student
            learning progress.
          </Text>
        </View>
      );
    ...
    default:
      return (
        <View className="w-full flex flex-col items-center gap-8">
          ...
          <Text className="text-black/60 text-[18px] font-light leading-[28.80px] break-words text-center">
            Atlas will be tailored to your way of studying. Take control of your
            Education
          </Text>
        </View>
      );
