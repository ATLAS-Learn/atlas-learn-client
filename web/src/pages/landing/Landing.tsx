  ...
  return (
    <div className='min-h-screen bg-white'>
      ...
      <section className='px-6 md:px-12 pt-20 pb-24 md:pt-32 md:pb-36 max-w-5xl mx-auto text-center'>
        <div className='inline-flex items-center gap-2 px-4 py-1.5 bg-gray-50 border border-gray-100 rounded-full text-xs font-medium text-gray-500 mb-8'>
      ...
      {/* Features */}
      <section className='px-6 md:px-12 py-20 bg-gray-50/50'>
