        ...
        {validating ? (
          ...
          <div className='text-center py-8'>
            ...
            <button
              ...
              className='px-6 py-2.5 bg-[#084A59] text-white rounded-lg hover:bg-[#011C26] transition-colors'
            >
              Go to Login
            </button>
          </div>
          ...
          <div className='text-center py-8'>
            ...
            <p className='text-gray-500 mb-6'>
              Your profile is set up. You can now log in.
            </p>
            <button
              onClick={() => navigate('/dashboard')}
              className='px-6 py-2.5 bg-[#084A59] text-white rounded-lg hover:bg-[#011C26] transition-colors'
          ...
          <>
            ...
            <div className='flex items-center justify-center gap-2 mb-6'>
              {Array.from({ length: totalSteps }, (_, i) => i + 1).map((s) => (
                <div key={s} className='flex items-center gap-2'>
                  ...
                  {s < totalSteps && (
                    <div
                      className={`w-8 h-0.5 ${step > s ? 'bg-[#084A59]' : 'bg-gray-200'}`}
                    />
                  )}
                </div>
              ))}
            ...
            {step === 1 && (
              <form onSubmit={handlePasswordSubmit}>
                ...
                <button
                  type='submit'
                  className='w-full py-3 bg-[#084A59] text-white font-semibold rounded-lg hover:bg-[#011C26] transition-colors text-base'
                >
                  Continue
                </button>
              </form>
            ...
            {step === 2 && (
              ...
              >
                ...
                <div className='flex gap-3'>
                  ...
                  <button
                    type='submit'
                    className='flex-1 py-3 bg-[#084A59] text-white font-semibold rounded-lg hover:bg-[#011C26] transition-colors text-base'
                  >
