        ...
        <div className='flex items-center justify-between'>
          <div>
            <div className='flex items-center gap-3'>
              <h2 className='text-2xl font-bold text-[#084A59]'>
                {subject.name}
              </h2>
        ...
        <div className='space-y-3'>
          {chapters.map((ch: any) => (
            <div
              ...
              onClick={() =>
                navigate(`/teacher/content/${subjectId}/chapters/${ch.id}`)
              }
            >
              <div className='flex items-start justify-between gap-4'>
                <div className='flex items-start gap-3 min-w-0 flex-1'>
                  <span className='w-9 h-9 rounded-xl bg-slate-100 text-slate-500 text-sm font-bold flex items-center justify-center shrink-0'>
                    {ch.orderIndex}
                  </span>
                    ...
                    <div className='flex flex-wrap gap-3 mt-2'>
                      ...
                      {ch._count?.lessons != null && (
                        <span className='text-xs text-gray-400'>
                          {ch._count.lessons} lesson
                          {ch._count.lessons !== 1 ? 's' : ''}
                        </span>
                      )}
                      {ch._count?.quizzes != null && (
                        <span className='text-xs text-gray-400'>
                          {ch._count.quizzes} quiz
                          {ch._count.quizzes !== 1 ? 'zes' : ''}
                        </span>
                      )}
                    </div>
                  </div>
            ...
            >
              ...
              <div>
                ...
                <RichTextEditor
                  ...
                  onChange={(val) =>
                    setChapterForm({ ...chapterForm, description: val })
                  }
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setChapterForm({
                        ...chapterForm,
                        unlockThreshold: Number(e.target.value),
                      })
                    }
                    min={0}
                    max={100}
